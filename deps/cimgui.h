...
// https://github.com/cimgui/cimgui based on imgui.h file version "1.91.9b"
// 19191 from Dear ImGui https://github.com/ocornut/imgui with imgui_internal.h
// api with imgui_freetype.h api docking branch
...
typedef enum {
  ...
  ImGuiDockNodeFlags_LocalFlagsTransferMask_ =
      ...
      (int)ImGuiDockNodeFlags_AutoHideTabBar | ImGuiDockNodeFlags_CentralNode |
...
typedef void (*ImGuiErrorCallback)(ImGuiContext* ctx,
                                   void* user_data,
                                   const char* msg);
typedef enum {
...
CIMGUI_API void igImage(ImTextureID user_texture_id,
                        ...
                        const ImVec2 uv0,
                        const ImVec2 uv1);
CIMGUI_API void igImageWithBg(ImTextureID user_texture_id,
                              const ImVec2 image_size,
                              const ImVec2 uv0,
                              const ImVec2 uv1,
                              const ImVec4 bg_col,
...
CIMGUI_API bool igSelectable_BoolPtr(const char* label,
                                     ...
                                     ImGuiSelectableFlags flags,
                                     const ImVec2 size);
CIMGUI_API ImGuiMultiSelectIO* igBeginMultiSelect(ImGuiMultiSelectFlags flags,
                                                  int selection_size,
                                                  int items_count);
...
CIMGUI_API ImGuiID igDockSpace(ImGuiID dockspace_id,
                               const ImVec2 size,
                               ImGuiDockNodeFlags flags,
                               const ImGuiWindowClass* window_class);
CIMGUI_API ImGuiID
igDockSpaceOverViewport(ImGuiID dockspace_id,
...
CIMGUI_API bool igIsMouseReleasedWithDelay(ImGuiMouseButton button,
                                           float delay);
...
CIMGUI_API void ImGuiListClipper_IncludeItemsByIndex(ImGuiListClipper* self,
                                                     int item_begin,
                                                     int item_end);
CIMGUI_API void ImGuiListClipper_SeekCursorForItem(ImGuiListClipper* self,
                                                   int item_index);
...
CIMGUI_API ImGuiSelectionBasicStorage*
ImGuiSelectionBasicStorage_ImGuiSelectionBasicStorage(void);
CIMGUI_API void ImGuiSelectionBasicStorage_destroy(
...
CIMGUI_API ImGuiID ImGuiSelectionBasicStorage_GetStorageIdFromIndex(
    ImGuiSelectionBasicStorage* self,
    int idx);
CIMGUI_API ImGuiSelectionExternalStorage*
ImGuiSelectionExternalStorage_ImGuiSelectionExternalStorage(void);
CIMGUI_API void ImGuiSelectionExternalStorage_destroy(
...
CIMGUI_API void ImDrawList__SetTextureID(ImDrawList* self,
                                         ImTextureID texture_id);
...
CIMGUI_API const char* igImStrbol(const char* buf_mid_line,
...
CIMGUI_API float igImLinearRemapClamp(float s0,
                                      float s1,
                                      float d0,
                                      float d1,
                                      float x);
...
CIMGUI_API void ImGuiTextIndex_append(ImGuiTextIndex* self,
                                      ...
                                      int old_size,
                                      int new_size);
CIMGUI_API ImGuiStoragePair* igImLowerBound(ImGuiStoragePair* in_begin,
...
CIMGUI_API void* ImGuiStyleVarInfo_GetVarPtr(ImGuiStyleVarInfo* self,
                                             void* parent);
...
CIMGUI_API void ImGuiInputTextState_OnKeyPressed(ImGuiInputTextState* self,
                                                 int key);
CIMGUI_API void ImGuiInputTextState_OnCharPressed(ImGuiInputTextState* self,
                                                  unsigned int c);
...
CIMGUI_API ImGuiErrorRecoveryState*
ImGuiErrorRecoveryState_ImGuiErrorRecoveryState(void);
...
CIMGUI_API ImGuiMultiSelectTempData*
ImGuiMultiSelectTempData_ImGuiMultiSelectTempData(void);
CIMGUI_API void ImGuiMultiSelectTempData_destroy(
    ImGuiMultiSelectTempData* self);
CIMGUI_API void ImGuiMultiSelectTempData_Clear(ImGuiMultiSelectTempData* self);
CIMGUI_API void ImGuiMultiSelectTempData_ClearIO(
    ImGuiMultiSelectTempData* self);
CIMGUI_API ImGuiMultiSelectState* ImGuiMultiSelectState_ImGuiMultiSelectState(
    void);
...
CIMGUI_API ImGuiID ImGuiWindow_GetIDFromPos(ImGuiWindow* self,
                                            const ImVec2 p_abs);
...
CIMGUI_API void igWindowRectRelToAbs(ImRect* pOut,
                                     ImGuiWindow* window,
                                     const ImRect r);
CIMGUI_API void igWindowPosAbsToRel(ImVec2* pOut,
                                    ImGuiWindow* window,
                                    const ImVec2 p);
...
CIMGUI_API bool igBeginPopupMenuEx(ImGuiID id,
                                   const char* label,
...
CIMGUI_API void igSetKeyOwnersForKeyChord(ImGuiKeyChord key,
                                          ImGuiID owner_id,
                                          ImGuiInputFlags flags);
CIMGUI_API void igSetItemKeyOwner_InputFlags(ImGuiKey key,
                                             ImGuiInputFlags flags);
...
CIMGUI_API bool igIsKeyPressed_InputFlags(ImGuiKey key,
                                          ImGuiInputFlags flags,
                                          ImGuiID owner_id);
CIMGUI_API bool igIsKeyReleased_ID(ImGuiKey key, ImGuiID owner_id);
CIMGUI_API bool igIsKeyChordPressed_InputFlags(ImGuiKeyChord key_chord,
                                               ImGuiInputFlags flags,
                                               ImGuiID owner_id);
CIMGUI_API bool igIsMouseDown_ID(ImGuiMouseButton button, ImGuiID owner_id);
CIMGUI_API bool igIsMouseClicked_InputFlags(ImGuiMouseButton button,
                                            ImGuiInputFlags flags,
                                            ImGuiID owner_id);
...
CIMGUI_API bool igIsMouseDoubleClicked_ID(ImGuiMouseButton button,
                                          ImGuiID owner_id);
CIMGUI_API bool igShortcut_ID(ImGuiKeyChord key_chord,
                              ImGuiInputFlags flags,
                              ImGuiID owner_id);
...
CIMGUI_API int igTypingSelectFindBestLeadingMatch(
    ...
    const char* (*get_item_name_func)(void*, int),
    void* user_data);
CIMGUI_API bool igBeginBoxSelect(const ImRect scope_rect,
                                 ImGuiWindow* window,
                                 ImGuiID box_select_id,
                                 ImGuiMultiSelectFlags ms_flags);
CIMGUI_API void igEndBoxSelect(const ImRect scope_rect,
                               ImGuiMultiSelectFlags ms_flags);
CIMGUI_API void igMultiSelectItemHeader(ImGuiID id,
                                        bool* p_selected,
                                        ImGuiButtonFlags* p_button_flags);
CIMGUI_API void igMultiSelectItemFooter(ImGuiID id,
                                        bool* p_selected,
                                        bool* p_pressed);
CIMGUI_API void igMultiSelectAddSetAll(ImGuiMultiSelectTempData* ms,
                                       bool selected);
CIMGUI_API void igMultiSelectAddSetRange(ImGuiMultiSelectTempData* ms,
                                         bool selected,
                                         int range_dir,
...
CIMGUI_API ImGuiID igTableGetColumnResizeID(ImGuiTable* table,
                                            int column_n,
                                            int instance_no);
CIMGUI_API float igTableCalcMaxColumnWidth(const ImGuiTable* table,
                                           int column_n);
...
CIMGUI_API void igTabBarQueueFocus_TabItemPtr(ImGuiTabBar* tab_bar,
                                              ImGuiTabItem* tab);
CIMGUI_API void igTabBarQueueFocus_Str(ImGuiTabBar* tab_bar,
                                       const char* tab_name);
...
CIMGUI_API void igTabItemSpacing(const char* str_id,
                                 ImGuiTabItemFlags flags,
                                 float width);
...
CIMGUI_API void igRenderColorRectWithAlphaCheckerboard(ImDrawList* draw_list,
                                                       ...
                                                       float rounding,
                                                       ImDrawFlags flags);
CIMGUI_API void igRenderNavCursor(const ImRect bb,
                                  ImGuiID id,
...
CIMGUI_API bool igTreeNodeUpdateNextOpen(ImGuiID storage_id,
                                         ImGuiTreeNodeFlags flags);
...
CIMGUI_API void igErrorRecoveryTryToRecoverWindowState(
    const ImGuiErrorRecoveryState* state_in);
...
CIMGUI_API void igDebugTextUnformattedWithLocateItem(const char* line_begin,
                                                     const char* line_end);
...
CIMGUI_API void igDebugNodePlatformMonitor(ImGuiPlatformMonitor* monitor,
                                           const char* label,
                                           int idx);
...
CIMGUI_API void igImFontAtlasBuildMultiplyRectAlpha8(
    ...
    int h,
    int stride);
CIMGUI_API void igImFontAtlasBuildGetOversampleFactors(const ImFontConfig* src,
                                                       int* out_oversample_h,
                                                       int* out_oversample_v);
CIMGUI_API bool igImFontAtlasGetMouseCursorTexData(ImFontAtlas* atlas,
...
// no appendfV
CIMGUI_API void ImGuiTextBuffer_appendf(ImGuiTextBuffer* self,
                                        const char* fmt,
                                        ...);
