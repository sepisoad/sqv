...
/*
    ...
    Optionally provide the following configuration define both before including
   the the declaration and implementation:
   ...
   3=info uint32_t log_item_id,           // SIMGUI_LOGITEM_* const char*
   message_or_null,    // a message string, may be nullptr in release mode
                    uint32_t line_nr,               // line number in
   sokol_imgui.h const char* filename_or_null,   // source filename, may be
   ...
   any warnings or errors.
    ...
    ====================
    You can call these functions from your platform's events to handle ImGui
   events when SOKOL_IMGUI_NO_SOKOL_APP is defined.

    E.g. mouse position events can be dispatched like this:

        simgui_add_mouse_pos_event(100, 200);

    For adding key events, you're responsible to map your own key codes to
   ImGuiKey values and pass those as int:
...
typedef enum simgui_log_item_t { _SIMGUI_LOG_ITEMS } simgui_log_item_t;
...
typedef struct simgui_logger_t {
  void (*func)(const char* tag,       // always "simgui"
...
typedef struct simgui_desc_t {
  ...
  bool disable_set_mouse_cursor;  // if true, don't control the mouse cursor
                                  // type via sapp_set_mouse_cursor()
  bool disable_windows_resize_from_edges;  // if true, only resize edges from
...
SOKOL_IMGUI_API_DECL uint64_t simgui_imtextureid_with_sampler(sg_image img,
                                                              sg_sampler smp);
SOKOL_IMGUI_API_DECL sg_image simgui_image_from_imtextureid(uint64_t imtex_id);
SOKOL_IMGUI_API_DECL sg_sampler
simgui_sampler_from_imtextureid(uint64_t imtex_id);
...
SOKOL_IMGUI_API_DECL void simgui_add_mouse_button_event(int mouse_button,
                                                        bool down);
SOKOL_IMGUI_API_DECL void simgui_add_mouse_wheel_event(float wheel_x,
                                                       float wheel_y);
...
SOKOL_IMGUI_API_DECL void simgui_add_touch_button_event(int mouse_button,
                                                        bool down);
#if !defined(SOKOL_IMGUI_NO_SOKOL_APP)
SOKOL_IMGUI_API_DECL bool simgui_handle_event(const sapp_event* ev);
SOKOL_IMGUI_API_DECL int simgui_map_keycode(
    sapp_keycode keycode);  // returns ImGuiKey_*
#endif
SOKOL_IMGUI_API_DECL void simgui_shutdown(void);
SOKOL_IMGUI_API_DECL void simgui_create_fonts_texture(
    const simgui_font_tex_desc_t* desc);
...
inline void simgui_create_fonts_texture(const simgui_font_tex_desc_t& desc) {
  return simgui_create_fonts_texture(&desc);
}
...
/*
   ...
   glsl410:glsl300es:hlsl4:metal_macos:metal_ios:metal_sim:wgsl -b
...
/*
    ...
    void main()
    {
        gl_Position = vec4(((position / vs_params[0].xy) - vec2(0.5)) *
   vec2(2.0, -2.0), 0.5, 1.0); uv = texcoord0; color = color0;
    }
*/
static const uint8_t _simgui_vs_source_glsl410[383] = {
    ...
    0x32, 0x20, 0x75, 0x76, 0x3b, 0x0a, 0x6c, 0x61, 0x79, 0x6f, 0x75, 0x74,
    0x28, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x20, 0x3d, 0x20,
    0x31, 0x29, 0x20, 0x69, 0x6e, 0x20, 0x76, 0x65, 0x63, 0x32, 0x20, 0x74,
    0x65, 0x78, 0x63, 0x6f, 0x6f, 0x72, 0x64, 0x30, 0x3b, 0x0a, 0x6c, 0x61,
    0x79, 0x6f, 0x75, 0x74, 0x28, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f,
    0x6e, 0x20, 0x3d, 0x20, 0x31, 0x29, 0x20, 0x6f, 0x75, 0x74, 0x20, 0x76,
    0x65, 0x63, 0x34, 0x20, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x3b, 0x0a, 0x6c,
    ...
    0x34, 0x28, 0x28, 0x28, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e,
    0x20, 0x2f, 0x20, 0x76, 0x73, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73,
    0x5b, 0x30, 0x5d, 0x2e, 0x78, 0x79, 0x29, 0x20, 0x2d, 0x20, 0x76, 0x65,
    0x63, 0x32, 0x28, 0x30, 0x2e, 0x35, 0x29, 0x29, 0x20, 0x2a, 0x20, 0x76,
    0x65, 0x63, 0x32, 0x28, 0x32, 0x2e, 0x30, 0x2c, 0x20, 0x2d, 0x32, 0x2e,
    0x30, 0x29, 0x2c, 0x20, 0x30, 0x2e, 0x35, 0x2c, 0x20, 0x31, 0x2e, 0x30,
    0x29, 0x3b, 0x0a, 0x20, 0x20, 0x20, 0x20, 0x75, 0x76, 0x20, 0x3d, 0x20,
    0x74, 0x65, 0x78, 0x63, 0x6f, 0x6f, 0x72, 0x64, 0x30, 0x3b, 0x0a, 0x20,
    0x20, 0x20, 0x20, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x20, 0x3d, 0x20, 0x63,
...
static const uint8_t _simgui_fs_source_glsl410[219] = {
    ...
    0x6d, 0x70, 0x6c, 0x65, 0x72, 0x32, 0x44, 0x20, 0x74, 0x65, 0x78, 0x5f,
    0x73, 0x6d, 0x70, 0x3b, 0x0a, 0x0a, 0x6c, 0x61, 0x79, 0x6f, 0x75, 0x74,
    0x28, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x20, 0x3d, 0x20,
    ...
    0x20, 0x20, 0x20, 0x20, 0x66, 0x72, 0x61, 0x67, 0x5f, 0x63, 0x6f, 0x6c,
    0x6f, 0x72, 0x20, 0x3d, 0x20, 0x74, 0x65, 0x78, 0x74, 0x75, 0x72, 0x65,
    0x28, 0x74, 0x65, 0x78, 0x5f, 0x73, 0x6d, 0x70, 0x2c, 0x20, 0x75, 0x76,
...
static const uint8_t _simgui_vs_source_glsl300es[344] = {
    ...
    ,
...
static const uint8_t _simgui_fs_source_glsl300es[250] = {
    ...
    ,
...
/*
    ...
    vertex main0_out main0(main0_in in [[stage_in]], constant vs_params& _22
   [[buffer(0)]])
    {
        main0_out out = {};
        out.gl_Position = float4(((in.position / _22.disp_size) - float2(0.5)) *
   float2(2.0, -2.0), 0.5, 1.0); out.uv = in.texcoord0; out.color = in.color0;
        return out;
    }
*/
static const uint8_t _simgui_vs_bytecode_metal_macos[3116] = {
    ...
    0x3b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x01, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x0c, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x0b, 0x00, 0x00,
    ...
    0x00, 0x6c, 0xc6, 0xce, 0x18, 0x4d, 0xb5, 0xf9, 0xae, 0x57, 0x9c, 0x34,
    0x76, 0x94, 0x96, 0x17, 0x9a, 0x2d, 0xca, 0x04, 0xbe, 0xda, 0x39, 0x87,
    0xd4, 0x9d, 0x6e, 0x8c, 0x73, 0xe8, 0x15, 0x57, 0xa2, 0x4f, 0x46, 0x46,
    ...
    0x00, 0x01, 0x00, 0x01, 0x00, 0x45, 0x4e, 0x44, 0x54, 0x37, 0x00, 0x00,
    0x00, 0x56, 0x41, 0x54, 0x54, 0x22, 0x00, 0x03, 0x00, 0x70, 0x6f, 0x73,
    0x69, 0x74, 0x69, 0x6f, 0x6e, 0x00, 0x00, 0x80, 0x74, 0x65, 0x78, 0x63,
    0x6f, 0x6f, 0x72, 0x64, 0x30, 0x00, 0x01, 0x80, 0x63, 0x6f, 0x6c, 0x6f,
    0x72, 0x30, 0x00, 0x02, 0x80, 0x56, 0x41, 0x54, 0x59, 0x05, 0x00, 0x03,
    0x00, 0x04, 0x04, 0x06, 0x45, 0x4e, 0x44, 0x54, 0x04, 0x00, 0x00, 0x00,
    ...
    0xd0, 0x01, 0xa0, 0x07, 0x79, 0xa8, 0x87, 0x72, 0x00, 0x36, 0x18, 0x02,
    0x01, 0x2c, 0x40, 0x05, 0x49, 0x18, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
    ...
    0x8c, 0x40, 0x00, 0x76, 0x08, 0x91, 0x83, 0xa4, 0x29, 0xa2, 0x84, 0xc9,
    0xaf, 0xa4, 0xff, 0x01, 0x22, 0x80, 0x91, 0x50, 0x10, 0x83, 0x08, 0x84,
    0x50, 0x8a, 0x89, 0x90, 0x22, 0x1b, 0x08, 0x98, 0x23, 0x00, 0x83, 0x14,
    0xc8, 0x39, 0x02, 0x50, 0x18, 0x44, 0x08, 0x84, 0x61, 0x04, 0x22, 0x19,
    0x01, 0x00, 0x00, 0x00, 0x13, 0xb2, 0x70, 0x48, 0x07, 0x79, 0xb0, 0x03,
    ...
    0x07, 0x71, 0x60, 0x07, 0x7a, 0x30, 0x07, 0x72, 0x30, 0x84, 0x39, 0x00,
    0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc8, 0x02, 0x01, 0x00, 0x00,
    0x09, 0x00, 0x00, 0x00, 0x32, 0x1e, 0x98, 0x10, 0x19, 0x11, 0x4c, 0x90,
    0x8c, 0x09, 0x26, 0x47, 0xc6, 0x04, 0x43, 0xca, 0x12, 0x18, 0x01, 0x28,
    0x88, 0x22, 0x28, 0x84, 0x32, 0xa0, 0x1d, 0x01, 0x20, 0x1d, 0x4b, 0x78,
    0x00, 0x00, 0x00, 0x00, 0x79, 0x18, 0x00, 0x00, 0xe9, 0x00, 0x00, 0x00,
    0x1a, 0x03, 0x4c, 0x10, 0x97, 0x29, 0xa2, 0x25, 0x10, 0xab, 0x32, 0xb9,
    0xb9, 0xb4, 0x37, 0xb7, 0x21, 0x46, 0x42, 0x20, 0x80, 0x82, 0x50, 0xb9,
    0x1b, 0x43, 0x0b, 0x93, 0xfb, 0x9a, 0x4b, 0xd3, 0x2b, 0x1b, 0x62, 0x24,
    0x01, 0x22, 0x24, 0x05, 0xe3, 0x20, 0x08, 0x0e, 0x8e, 0xad, 0x0c, 0xa4,
    ...
    0x66, 0xc6, 0x65, 0x66, 0xa6, 0x26, 0x65, 0x88, 0x80, 0x10, 0x43, 0x8c,
    0x24, 0x48, 0x86, 0x44, 0x60, 0xd1, 0x54, 0x46, 0x17, 0xc6, 0x36, 0x04,
    0x41, 0x8e, 0x24, 0x48, 0x82, 0x44, 0xe0, 0x16, 0x96, 0x26, 0xe7, 0x32,
    0xf6, 0xd6, 0x06, 0x97, 0xc6, 0x56, 0xe6, 0x42, 0x56, 0xe6, 0xf6, 0x26,
    0xd7, 0x36, 0xf7, 0x45, 0x96, 0x36, 0x17, 0x26, 0xc6, 0x56, 0x36, 0x44,
    0x40, 0x12, 0x72, 0x61, 0x69, 0x72, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x69,
    0x6c, 0x65, 0x2e, 0x66, 0x61, 0x73, 0x74, 0x5f, 0x6d, 0x61, 0x74, 0x68,
    0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x43, 0x04, 0x64, 0x61, 0x19,
    ...
    0x95, 0x0d, 0x11, 0x90, 0x86, 0x51, 0x58, 0x9a, 0x9c, 0x8b, 0x5d, 0x99,
    ...
    ,
    ...
    ,
    ...
    0x42, 0xf0, 0x3c, 0x94, 0x33, 0x00, 0x14, 0x63, 0x09, 0x20, 0x08, 0x82,
    0xf0, 0x2f, 0x80, 0x20, 0x08, 0xc2, 0xbf, 0x30, 0x96, 0x00, 0x82, 0x20,
    0x08, 0x82, 0x01, 0x08, 0x82, 0x20, 0x08, 0x0e, 0x33, 0x00, 0x24, 0x73,
    0x10, 0xd7, 0x65, 0x55, 0x34, 0x33, 0x00, 0x04, 0x63, 0x04, 0x20, 0x08,
    0x82, 0xf8, 0x37, 0x46, 0x00, 0x82, 0x20, 0x08, 0x7f, 0x33, 0x00, 0x00,
    0xe3, 0x0d, 0x4c, 0x64, 0x51, 0x40, 0x2c, 0x0a, 0xe8, 0x63, 0xc1, 0x02,
    0x1f, 0x0b, 0x16, 0xf9, 0x0c, 0x32, 0x04, 0xcb, 0x33, 0xc8, 0x10, 0x2c,
    0xd1, 0x6c, 0xc3, 0x52, 0x01, 0xb3, 0x0d, 0x41, 0x15, 0xcc, 0x36, 0x04,
    0x83, 0x90, 0x41, 0x40, 0x0c, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
    0x5b, 0x86, 0x20, 0xc0, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
/*
    ...
    fragment main0_out main0(main0_in in [[stage_in]], texture2d<float> tex
   [[texture(0)]], sampler smp [[sampler(0)]])
    {
        main0_out out = {};
...
static const uint8_t _simgui_fs_bytecode_metal_macos[3017] = {
    ,
    ...
    0x00, 0xdc, 0x0a, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x42, 0x43, 0xc0,
    0xde, 0x21, 0x0c, 0x00, 0x00, 0xb4, 0x02, 0x00, 0x00, 0x0b, 0x82, 0x20,
    ...
    0x44, 0xff, 0x34, 0x46, 0x00, 0x0c, 0x22, 0x18, 0x42, 0x29, 0xc4, 0x08,
    ...
    0x50, 0x04, 0x85, 0x50, 0x10, 0x65, 0x40, 0x70, 0x2c, 0xe1, 0x01, 0x00,
    ...
    0x06, 0x46, 0x66, 0xc6, 0x65, 0x66, 0xa6, 0x06, 0x04, 0xa5, 0xad, 0x8c,
    0x2e, 0x8c, 0xcd, 0xac, 0xac, 0x65, 0x46, 0x06, 0x46, 0x66, 0xc6, 0x65,
    0x66, 0xa6, 0x26, 0x65, 0x88, 0xf0, 0x10, 0x43, 0x8c, 0x45, 0x58, 0x8c,
    ...
    ,
    ...
    0x43, 0x39, 0xb8, 0x03, 0x3d, 0x4c, 0x09, 0xd6, 0x00, 0x79, 0x18, 0x00,
    ...
    0x07, 0x00, 0x00, 0x00, 0x00, 0x71, 0x20, 0x00, 0x00, 0x08, 0x00, 0x00,
    ...
    0x00, 0x11, 0x00, 0x00, 0x00, 0x13, 0x04, 0x41, 0x2c, 0x10, 0x00, 0x00,
    0x00, 0x04, 0x00, 0x00, 0x00, 0xc4, 0x46, 0x00, 0x48, 0x8d, 0x00, 0xd4,
    0x00, 0x89, 0x19, 0x00, 0x02, 0x23, 0x00, 0x00, 0x00, 0x23, 0x06, 0xca,
    0x10, 0x44, 0x87, 0x91, 0x0c, 0x05, 0x11, 0x58, 0x90, 0xc8, 0x67, 0xb6,
    0x81, 0x08, 0x80, 0x0c, 0x02, 0x62, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
    0x00, 0x5b, 0x06, 0xe0, 0x90, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static const uint8_t _simgui_vs_bytecode_metal_ios[3212] = {
    ...
    ,
    ...
    0x42, 0x43, 0xc0, 0xde, 0x21, 0x0c, 0x00, 0x00, 0xd6, 0x02, 0x00, 0x00,
    0x0b, 0x82, 0x20, 0x00, 0x02, 0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00,
    0x07, 0x81, 0x23, 0x91, 0x41, 0xc8, 0x04, 0x49, 0x06, 0x10, 0x32, 0x39,
    0x92, 0x01, 0x84, 0x0c, 0x25, 0x05, 0x08, 0x19, 0x1e, 0x04, 0x8b, 0x62,
    0x80, 0x10, 0x45, 0x02, 0x42, 0x92, 0x0b, 0x42, 0x84, 0x10, 0x32, 0x14,
    ...
    0x07, 0x00, 0x0f, 0x00, 0xa2, 0x1e, 0xdc, 0x61, 0x1e, 0xc2, 0xc1, 0x1c,
    0xca, 0xa1, 0x0d, 0xcc, 0x01, 0x1e, 0xda, 0xa0, 0x1d, 0xc2, 0x81, 0x1e,
    0xd0, 0x01, 0xa0, 0x07, 0x79, 0xa8, 0x87, 0x72, 0x00, 0x36, 0x6c, 0x02,
    ...
    0x10, 0x3c, 0x33, 0x00, 0xc3, 0x08, 0x02, 0x30, 0x8c, 0x40, 0x00, 0x76,
    0x08, 0x91, 0x83, 0xa4, 0x29, 0xa2, 0x84, 0xc9, 0xaf, 0xa4, 0xff, 0x01,
    0x22, 0x80, 0x91, 0x50, 0x10, 0x83, 0x08, 0x84, 0x50, 0x8a, 0x89, 0x90,
    0x22, 0x1b, 0x08, 0x98, 0x23, 0x00, 0x83, 0x14, 0xc8, 0x39, 0x02, 0x50,
    0x18, 0x44, 0x08, 0x84, 0x61, 0x04, 0x22, 0x19, 0x01, 0x00, 0x00, 0x00,
    ...
    0x09, 0x00, 0x00, 0x00, 0x32, 0x1e, 0x98, 0x10, 0x19, 0x11, 0x4c, 0x90,
    0x8c, 0x09, 0x26, 0x47, 0xc6, 0x04, 0x43, 0xca, 0x12, 0x18, 0x01, 0x28,
    0x88, 0x22, 0x28, 0x84, 0x32, 0xa0, 0x1d, 0x01, 0x20, 0x1d, 0x4b, 0x90,
    0x00, 0x00, 0x00, 0x00, 0x79, 0x18, 0x00, 0x00, 0xfa, 0x00, 0x00, 0x00,
    0x1a, 0x03, 0x4c, 0x10, 0x97, 0x29, 0xa2, 0x25, 0x10, 0xab, 0x32, 0xb9,
    0xb9, 0xb4, 0x37, 0xb7, 0x21, 0x46, 0x42, 0x20, 0x80, 0x82, 0x50, 0xb9,
    0x1b, 0x43, 0x0b, 0x93, 0xfb, 0x9a, 0x4b, 0xd3, 0x2b, 0x1b, 0x62, 0x24,
    0x01, 0x22, 0x24, 0x05, 0xe3, 0x20, 0x08, 0x0e, 0x8e, 0xad, 0x0c, 0xa4,
    ...
    0x40, 0x12, 0x72, 0x61, 0x69, 0x72, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x69,
    0x6c, 0x65, 0x2e, 0x66, 0x61, 0x73, 0x74, 0x5f, 0x6d, 0x61, 0x74, 0x68,
    0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x43, 0x04, 0x64, 0x21, 0x19,
    0x84, 0xa5, 0xc9, 0xb9, 0x8c, 0xbd, 0xb5, 0xc1, 0xa5, 0xb1, 0x95, 0xb9,
    0x98, 0xc9, 0x85, 0xb5, 0x95, 0x89, 0xd5, 0x99, 0x99, 0x95, 0xc9, 0x7d,
    0x99, 0x95, 0xd1, 0x8d, 0xa1, 0x7d, 0x95, 0xb9, 0x85, 0x89, 0xb1, 0x95,
    0x0d, 0x11, 0x90, 0x86, 0x51, 0x58, 0x9a, 0x9c, 0x8b, 0x5d, 0x99, 0x1c,
    0x5d, 0x19, 0xde, 0xd7, 0x5b, 0x1d, 0x1d, 0x5c, 0x1d, 0x1d, 0x97, 0xba,
    0xb9, 0x32, 0x39, 0x14, 0xb6, 0xb7, 0x31, 0x37, 0x98, 0x14, 0x46, 0x61,
    ...
    0x51, 0xa8, 0xb3, 0x1b, 0xc2, 0x20, 0x0f, 0x02, 0x21, 0x11, 0x22, 0x21,
    0x13, 0x42, 0x71, 0xa9, 0x9b, 0x2b, 0x93, 0x43, 0x61, 0x7b, 0x1b, 0x73,
    0x8b, 0x49, 0xa1, 0x61, 0xc6, 0xf6, 0x16, 0x46, 0x47, 0xc3, 0x62, 0xec,
    0x8d, 0xed, 0x4d, 0x6e, 0x08, 0x83, 0x3c, 0x88, 0x85, 0x44, 0xc8, 0x85,
    0x4c, 0x08, 0x46, 0x26, 0x2c, 0x4d, 0xce, 0x05, 0xee, 0x6d, 0x2e, 0x8d,
    0x2e, 0xed, 0xcd, 0x8d, 0xcb, 0x19, 0xdb, 0x17, 0xd4, 0xdb, 0x5c, 0x1a,
    0x5d, 0xda, 0x9b, 0xdb, 0x10, 0x05, 0xd1, 0x90, 0x08, 0xb9, 0x90, 0x09,
    0xd9, 0x86, 0x18, 0x48, 0x85, 0x64, 0x08, 0x47, 0x28, 0x2c, 0x4d, 0xce,
    ...
    0xaf, 0xaf, 0x14, 0x22, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e,
    0x43, 0xa8, 0x44, 0x40, 0x3c, 0xe4, 0x4b, 0x84, 0x24, 0x40, 0xc0, 0x00,
    0x89, 0x10, 0x09, 0x99, 0x90, 0x30, 0x60, 0x42, 0x57, 0x86, 0x37, 0xf6,
    0xf6, 0x26, 0x47, 0x06, 0x33, 0x84, 0x4a, 0x02, 0xc4, 0x43, 0xbe, 0x24,
    0x48, 0x02, 0x04, 0x0c, 0x90, 0x08, 0x91, 0x90, 0x09, 0x19, 0x03, 0x1a,
    0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x30, 0x43, 0xa8, 0x84, 0x40, 0x3c, 0xe4,
    0x4b, 0x88, 0x24, 0x40, 0xc0, 0x00, 0x89, 0x90, 0x0b, 0x99, 0x90, 0x32,
    ...
    0x19, 0xa9, 0xb0, 0x34, 0x39, 0x97, 0x39, 0x3a, 0xb9, 0xba, 0x31, 0xba,
    0x2f, 0xba, 0x3c, 0xb8, 0xb2, 0xaf, 0x34, 0x37, 0xb3, 0x37, 0x26, 0x64,
    0x69, 0x73, 0x70, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x43, 0x94, 0x44, 0x48,
    0x86, 0x44, 0x40, 0x24, 0x64, 0x0d, 0x18, 0x85, 0xa5, 0xc9, 0xb9, 0x84,
    ...
    ,
    ...
    ,
};
/*
    #include <metal_stdlib>
...
static const uint8_t _simgui_fs_bytecode_metal_ios[3017] = {
    ...
    ,
    ...
    0x2c, 0x41, 0x02, 0x00, 0x00, 0x79, 0x18, 0x00, 0x00, 0xd2, 0x00, 0x00,
    ...
    0x46, 0x66, 0xc6, 0x65, 0x66, 0xa6, 0x26, 0x65, 0x88, 0xf0, 0x10, 0x43,
    ...
    0xca, 0xa8, 0x98, 0xc9, 0x85, 0x9d, 0x7d, 0x8d, 0xbd, 0xb1, 0xbd, 0xc9,
    0x0d, 0x61, 0x9e, 0x67, 0x19, 0x1e, 0xe8, 0x89, 0x1e, 0xe9, 0x99, 0x86,
    0x08, 0x0f, 0x45, 0x29, 0x2c, 0x4d, 0xce, 0xc5, 0x4c, 0x2e, 0xec, 0xac,
    ...
    0x65, 0x34, 0xcc, 0xd8, 0xde, 0xc2, 0xe8, 0x64, 0x28, 0xd4, 0xd9, 0x0d,
    0x91, 0x96, 0xe1, 0xb1, 0x9e, 0xeb, 0xc1, 0x9e, 0xec, 0x81, 0x1e, 0xed,
    0x91, 0x9e, 0x8d, 0x4b, 0xdd, 0x5c, 0x99, 0x1c, 0x0a, 0xdb, 0xdb, 0x98,
    0x5b, 0x4c, 0x0a, 0x8b, 0xb1, 0x37, 0xb6, 0x37, 0xb9, 0x21, 0xd2, 0x22,
    0x3c, 0xd6, 0xd3, 0x3d, 0xd8, 0x93, 0x3d, 0xd0, 0x13, 0x3d, 0xd2, 0xe3,
    0x71, 0x09, 0x4b, 0x93, 0x73, 0xa1, 0x2b, 0xc3, 0xa3, 0xab, 0x93, 0x2b,
    0xa3, 0x14, 0x96, 0x26, 0xe7, 0xc2, 0xf6, 0x36, 0x16, 0x46, 0x97, 0xf6,
    0xe6, 0xf6, 0x95, 0xe6, 0x46, 0x56, 0x86, 0x47, 0x25, 0x2c, 0x4d, 0xce,
    ...
    ,
    ...
    0xc3, 0x39, 0xb4, 0x43, 0x39, 0xb8, 0x03, 0x3d, 0x4c, 0x09, 0xd6, 0x00,
    ...
    0x00, 0x08, 0x00, 0x00, 0x00, 0x16, 0xb0, 0x01, 0x48, 0xe4, 0x4b, 0x00,
    0xf3, 0x2c, 0xc4, 0x3f, 0x11, 0xd7, 0x44, 0x45, 0xc4, 0x6f, 0x0f, 0x7e,
    0x85, 0x17, 0xb7, 0x6d, 0x00, 0x05, 0x03, 0x20, 0x0d, 0x0d, 0x00, 0x00,
    0x00, 0x61, 0x20, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x13, 0x04, 0x41,
    0x2c, 0x10, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xc4, 0x46, 0x00,
    0x48, 0x8d, 0x00, 0xd4, 0x00, 0x89, 0x19, 0x00, 0x02, 0x23, 0x00, 0x00,
    0x00, 0x23, 0x06, 0xca, 0x10, 0x44, 0x87, 0x91, 0x0c, 0x05, 0x11, 0x58,
    0x90, 0xc8, 0x67, 0xb6, 0x81, 0x08, 0x80, 0x0c, 0x02, 0x62, 0x00, 0x00,
    0x00, 0x02, 0x00, 0x00, 0x00, 0x5b, 0x06, 0xe0, 0x90, 0x03, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
};
/*
...
static const uint8_t _simgui_vs_source_metal_sim[672] = {
    ...
    0x26, 0x20, 0x5f, 0x32, 0x32, 0x20, 0x5b, 0x5b, 0x62, 0x75, 0x66, 0x66,
    ...
    0x69, 0x74, 0x69, 0x6f, 0x6e, 0x20, 0x2f, 0x20, 0x5f, 0x32, 0x32, 0x2e,
    ...
    0x2e, 0x35, 0x2c, 0x20, 0x31, 0x2e, 0x30, 0x29, 0x3b, 0x0a, 0x20, 0x20,
...
static const uint8_t _simgui_fs_source_metal_sim[436] = {
    ...
    0x72, 0x20, 0x73, 0x6d, 0x70, 0x20, 0x5b, 0x5b, 0x73, 0x61, 0x6d, 0x70,
    ...
    0x2e, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x28, 0x73, 0x6d, 0x70, 0x2c,
    0x20, 0x69, 0x6e, 0x2e, 0x75, 0x76, 0x29, 0x20, 0x2a, 0x20, 0x69, 0x6e,
...
/*
    ...
    void vert_main()
    {
        gl_Position = float4(((position / _22_disp_size) - 0.5f.xx) *
   float2(2.0f, -2.0f), 0.5f, 1.0f); uv = texcoord0; color = color0;
    }
...
static const uint8_t _simgui_vs_bytecode_hlsl4[892] = {
    0x44, 0x58, 0x42, 0x43, 0x0d, 0xbd, 0x9e, 0x9e, 0x7d, 0xc0, 0x2b, 0x54,
    0x88, 0xf9, 0xca, 0x89, 0x32, 0xe4, 0x0c, 0x59, 0x01, 0x00, 0x00, 0x00,
    ...
    0x5f, 0x32, 0x32, 0x5f, 0x64, 0x69, 0x73, 0x70, 0x5f, 0x73, 0x69, 0x7a,
...
static const uint8_t _simgui_fs_bytecode_hlsl4[608] = {
    0x44, 0x58, 0x42, 0x43, 0x3a, 0xa7, 0x41, 0x21, 0xb4, 0x2d, 0xa7, 0x6e,
    0xfe, 0x31, 0xb0, 0xe0, 0x14, 0xe0, 0xdf, 0x5a, 0x01, 0x00, 0x00, 0x00,
    0x60, 0x02, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00,
    0xc8, 0x00, 0x00, 0x00, 0x14, 0x01, 0x00, 0x00, 0x48, 0x01, 0x00, 0x00,
    0xe4, 0x01, 0x00, 0x00, 0x52, 0x44, 0x45, 0x46, 0x8c, 0x00, 0x00, 0x00,
...
/*
    ...
    fn main_1() {
      ...
      let x_33 : vec2f = (((x_19 / x_25) - vec2f(0.5f, 0.5f)) * vec2f(2.0f,
   -2.0f)); gl_Position = vec4f(x_33.x, x_33.y, 0.5f, 1.0f); let x_43 : vec2f =
   texcoord0; uv = x_43; let x_47 : vec4f = color0; color = x_47; return;
    }
    ...
    @vertex
    fn main(@location(0) position_1_param : vec2f, @location(1) texcoord0_param
   : vec2f, @location(2) color0_param : vec4f) -> main_out { position_1 =
   position_1_param; texcoord0 = texcoord0_param; color0 = color0_param;
      main_1();
      return main_out(gl_Position, uv, color);
    }
*/
static const uint8_t _simgui_vs_source_wgsl[1083] = {
    ,
    ...
    ,
};
/*
    diagnostic(off, derivative_uniformity);
    ...
    @fragment
    fn main(@location(0) uv_param : vec2f, @location(1) color_param : vec4f) ->
   main_out { uv = uv_param; color = color_param; main_1(); return
   main_out(frag_color);
    }
...
static const uint8_t _simgui_fs_source_wgsl[630] = {
    ...
    0x66, 0x66, 0x2c, 0x20, 0x64, 0x65, 0x72, 0x69, 0x76, 0x61, 0x74, 0x69,
    0x76, 0x65, 0x5f, 0x75, 0x6e, 0x69, 0x66, 0x6f, 0x72, 0x6d, 0x69, 0x74,
    0x79, 0x29, 0x3b, 0x0a, 0x0a, 0x76, 0x61, 0x72, 0x3c, 0x70, 0x72, 0x69,
    0x76, 0x61, 0x74, 0x65, 0x3e, 0x20, 0x66, 0x72, 0x61, 0x67, 0x5f, 0x63,
    0x6f, 0x6c, 0x6f, 0x72, 0x20, 0x3a, 0x20, 0x76, 0x65, 0x63, 0x34, 0x66,
    0x3b, 0x0a, 0x0a, 0x40, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x28, 0x31, 0x29,
    0x20, 0x40, 0x62, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x28, 0x36, 0x34,
    0x29, 0x20, 0x76, 0x61, 0x72, 0x20, 0x74, 0x65, 0x78, 0x20, 0x3a, 0x20,
    ...
    ,
...
#else
#error \
    "Please define one of SOKOL_GLCORE, SOKOL_GLES3, SOKOL_D3D11, SOKOL_METAL, SOKOL_WGPU or SOKOL_DUMMY_BACKEND!"
#endif
...
static const char* _simgui_log_messages[] = {_SIMGUI_LOG_ITEMS};
#undef _SIMGUI_LOGITEM_XMACRO
#endif  // SOKOL_DEBUG
...
#define _SIMGUI_LOGMSG(code, msg) \
  _simgui_log(SIMGUI_LOGITEM_##code, 3, msg, __LINE__)

static void _simgui_log(simgui_log_item_t log_item,
                        uint32_t log_level,
                        const char* msg,
                        uint32_t line_nr) {
...
#endif
    _simgui.desc.logger.func("simgui", log_level, (uint32_t)log_item, msg,
                             line_nr, filename, _simgui.desc.logger.user_data);
  } else {
...
static void* _simgui_malloc(size_t size) {
  ...
  if (_simgui.desc.allocator.alloc_fn) {
    ptr =
        _simgui.desc.allocator.alloc_fn(size, _simgui.desc.allocator.user_data);
  } else {
    ptr = malloc(size);
  }
  if (0 == ptr) {
...
// initialize Dear ImGui
  ...
  switch (sg_query_backend()) {
    case SG_BACKEND_METAL_MACOS:
      ...
      shd_desc.fragment_func.bytecode =
          SG_RANGE(_simgui_fs_bytecode_metal_macos);
      break;
...
SOKOL_API_IMPL void simgui_create_fonts_texture(
    const simgui_font_tex_desc_t* desc) {
  SOKOL_ASSERT(desc);
  ...
  font_img_desc.data.subimage[0][0].size =
  ...
  io->Fonts->TexID =
      simgui_imtextureid_with_sampler(_simgui.font_img, _simgui.font_smp);
}
...
SOKOL_API_IMPL uint64_t simgui_imtextureid_with_sampler(sg_image img,
                                                        sg_sampler smp) {
...
static sg_pipeline _simgui_bind_image_sampler(sg_bindings* bindings,
                                              ImTextureID imtex_id) {
  bindings->images[0] = simgui_image_from_imtextureid(imtex_id);
  bindings->samplers[0] = simgui_sampler_from_imtextureid(imtex_id);
  if (sg_query_pixelformat(sg_query_image_pixelformat(bindings->images[0]))
          .filter) {
...
_SOKOL_PRIVATE void _simgui_add_sapp_key_event(ImGuiIO* io,
                                               sapp_keycode sapp_key,
                                               bool down) {
...
_SOKOL_PRIVATE void _simgui_add_imgui_key_event(ImGuiIO* io,
                                                ImGuiKey imgui_key,
                                                bool down) {
#if defined(__cplusplus)
  io->AddKeyEvent(imgui_key, down);
...
_SOKOL_PRIVATE void _simgui_update_modifiers(ImGuiIO* io, uint32_t mods) {
  _simgui_add_imgui_key_event(io, ImGuiMod_Ctrl,
                              (mods & SAPP_MODIFIER_CTRL) != 0);
  _simgui_add_imgui_key_event(io, ImGuiMod_Shift,
                              (mods & SAPP_MODIFIER_SHIFT) != 0);
  _simgui_add_imgui_key_event(io, ImGuiMod_Alt,
                              (mods & SAPP_MODIFIER_ALT) != 0);
  _simgui_add_imgui_key_event(io, ImGuiMod_Super,
                              (mods & SAPP_MODIFIER_SUPER) != 0);
}
...
SOKOL_API_IMPL bool simgui_handle_event(const sapp_event* ev) {
  ...
  switch (ev->type) {
    ...
    case SAPP_EVENTTYPE_MOUSE_DOWN:
      simgui_add_mouse_pos_event(ev->mouse_x / dpi_scale,
                                 ev->mouse_y / dpi_scale);
...
// "platform behaviour flags".
    ...
    case SAPP_EVENTTYPE_TOUCHES_BEGAN:
      simgui_add_touch_pos_event(ev->touches[0].pos_x / dpi_scale,
