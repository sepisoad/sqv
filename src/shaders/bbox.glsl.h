...
/*
    ...
    Cmdline:
        sokol-shdc -m bbox -i src/shaders/bbox.glsl -l glsl410 -f sokol -o src/shaders/bbox.glsl.h
...
#error "Please include sokol_gfx.h before bbox.glsl.h"
#endif
...
*/
static const uint8_t bbox_vs_source_glsl410[250] = {
...
*/
static const uint8_t bbox_fs_source_glsl410[135] = {
...
static inline const sg_shader_desc* bbox_md1_bbox_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)bbox_vs_source_glsl410;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)bbox_fs_source_glsl410;
