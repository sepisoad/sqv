...
/*
    ...
    Cmdline:
        sokol-shdc -m bbox -i src/shaders/bbox.glsl -l hlsl5 -f sokol -o src/shaders/bbox.d3d.h

    Overview:
    =========
    Shader program: 'md1_bbox':
        Get shader desc: bbox_md1_bbox_shader_desc(sg_query_backend());
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_bbox_md1_bbox_position => 0
    Bindings:
        Uniform block 'vs_params':
            C struct: bbox_vs_params_t
            Bind slot: UB_bbox_vs_params => 0
*/
#if !defined(SOKOL_GFX_INCLUDED)
#error "Please include sokol_gfx.h before bbox.d3d.h"
#endif
...
#endif
#endif
#define ATTR_bbox_md1_bbox_position (0)
#define UB_bbox_vs_params (0)
#pragma pack(push,1)
SOKOL_SHDC_ALIGN(16) typedef struct bbox_vs_params_t {
    hmm_mat4 mvp;
} bbox_vs_params_t;
#pragma pack(pop)
/*
...
*/
static const uint8_t bbox_vs_source_hlsl5[665] = {
    ...
    0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x2c,0x20,0x5f,0x31,0x39,0x5f,0x6d,0x76,0x70,
...
*/
static const uint8_t bbox_fs_source_hlsl5[435] = {
...
static inline const sg_shader_desc* bbox_md1_bbox_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_D3D11) {
        static sg_shader_desc desc;
        static bool valid;
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)bbox_vs_source_hlsl5;
            desc.vertex_func.d3d11_target = "vs_5_0";
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)bbox_fs_source_hlsl5;
            ...
            desc.label = "bbox_md1_bbox_shader";
        }
        return &desc;
    }
    return 0;
