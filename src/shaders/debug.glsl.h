...
/*
    ...
    Cmdline:
        sokol-shdc -m debug -i src/shaders/debug.glsl -l glsl410 -f sokol -o src/shaders/debug.glsl.h

    Overview:
    =========
    Shader program: 'md1_model_debug':
        Get shader desc: debug_md1_model_debug_shader_desc(sg_query_backend());
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_debug_md1_model_debug_position => 0
            ATTR_debug_md1_model_debug_color0 => 1
    Bindings:
*/
#if !defined(SOKOL_GFX_INCLUDED)
#error "Please include sokol_gfx.h before debug.glsl.h"
#endif
...
#endif
#endif
#define ATTR_debug_md1_model_debug_position (0)
#define ATTR_debug_md1_model_debug_color0 (1)
/*
    #version 410
...
*/
static const uint8_t debug_vs_source_glsl410[194] = {
...
*/
static const uint8_t debug_fs_source_glsl410[135] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x31,0x30,0x0a,0x0a,0x6c,0x61,
    0x79,0x6f,0x75,0x74,0x28,0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,
...
static inline const sg_shader_desc* debug_md1_model_debug_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        static sg_shader_desc desc;
        static bool valid;
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)debug_vs_source_glsl410;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)debug_fs_source_glsl410;
            desc.fragment_func.entry = "main";
            desc.attrs[0].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.attrs[0].glsl_name = "position";
            desc.attrs[1].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.attrs[1].glsl_name = "color0";
            desc.label = "debug_md1_model_debug_shader";
        }
        return &desc;
    }
    return 0;
