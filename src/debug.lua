...
local load_texture = require("nuklear.texture")
...
local prog1, vsh, fsh = gl.make_program({vertex="./res/shaders/6.multiple_lights.vert",
                                         fragment="./res/shaders/6.multiple_lights.frag"})
gl.delete_shaders(vsh, fsh)
-- lamp shader program:
local prog2, vsh, fsh = gl.make_program({vertex="./res/shaders/6.light_cube.vert",
                                         fragment="./res/shaders/6.light_cube.frag"})
gl.delete_shaders(vsh, fsh)
...
local diffuse_map = load_texture("./res/textures/container2.png")
local specular_map = load_texture("./res/textures/container2_specular.png")
