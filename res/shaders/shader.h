...
/*
    ...
    =========
    Shader program: 'sepi':
        Get shader desc: sepi_shader_desc(sg_query_backend());
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_sepi_pos => 0
            ATTR_sepi_texcoord0 => 1
    Bindings:
...
#endif
#endif
#define ATTR_sepi_pos (0)
#define ATTR_sepi_texcoord0 (1)
...
static inline const sg_shader_desc* sepi_shader_desc(sg_backend backend) {
